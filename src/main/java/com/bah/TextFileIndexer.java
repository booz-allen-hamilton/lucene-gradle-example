/**
 * An example program from lucenetutorial.com
 * that demonstrates some of the basic concepts of Lucene.
 *
 * The original version is found at http://www.lucenetutorial.com/sample-apps/textfileindexer-java.html
 */
package com.bah;
